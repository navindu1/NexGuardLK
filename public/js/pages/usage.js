...
function displayUserData(data, name, container) {
    const down = parseInt(data.down || 0, 10) || 0;
    const up = parseInt(data.up || 0, 10) || 0;
    const totalUsed = down + up;
    const totalQuota = parseInt(data.total || 0, 10) || 0;
    ...
    const expiryTimestamp = parseInt(data.expiryTime || 0, 10);
    ...
    renderFunc(pageStyles + `
        <div class="page" id="page-usage">
            ...
            <div id="help-modal" class="help-modal-overlay fixed inset-0 z-[100] flex justify-center items-center p-4">
                ...
                <div class="help-modal-content p-6 space-y-4 w-full max-w-md">
                    ...
                    <div class="bg-black/40 border border-white/10 rounded-xl p-2 shadow-inner">
