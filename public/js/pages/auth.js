...
export function renderAuthPage(renderFunc, params, initialPanel = "signin") {
        ...
        <div id="auth-container" class="mx-auto my-12 card-glass custom-radius p-8 sm:p-10 relative">
            ...
            <form class="auth-form space-y-5" id="signin-form">
                ...
                <div class="text-right text-sm -mt-3">
                    <span id="show-forgot-password" class="auth-toggle-link hover:underline">Forgot Password?</span>
                </div>
            ...
            <form class="auth-form space-y-5" id="signup-form">
                ...
                <div class="form-group">
                    <input type="text" id="signup-username" class="form-input" required placeholder=" " />
                    <label for="signup-username" class="form-label">Username</label>
                    <span class="focus-border"><i></i></span>
                </div>

                <div class="form-group">
                    <input type="email" id="signup-email" class="form-input" required placeholder=" " />
                    <label for="signup-email" class="form-label">Email</label>
                    <span class="focus-border"><i></i></span>
                </div>

                <div class="form-group">
                    <input type="tel" id="signup-whatsapp" class="form-input" required placeholder=" " value="94" minlength="11" maxlength="11" />
                    <label for="signup-whatsapp" class="form-label">WhatsApp Number</label>
                    <span class="focus-border"><i></i></span>
                </div>

                <div class="form-group relative">
                    <input type="password" id="signup-password" class="form-input pr-10" required placeholder=" " />
            ...
            <form class="auth-form space-y-6" id="otp-form">
                ...
                <div class="form-group">
                    <input type="text" id="otp-code" class="form-input" required placeholder=" " maxlength="6" />
            ...
            <form class="auth-form space-y-6" id="whatsapp-update-form">
                ...
                <div class="form-group">
                    ...
                    <label for="google-whatsapp-input" class="form-label">WhatsApp Number</label>
                    <span class="focus-border"><i></i></span>
                </div>
            ...
            <div class="auth-form" id="link-account-form-container">
                ...
                <form id="link-account-form" class="mt-8 space-y-6">
                    ...
                    <div class="text-center text-sm mt-4">
                        <span class="open-help-modal-link text-blue-400 cursor-pointer hover:underline">How to find your username?</span>
                    </div>
            ...
            <form class="auth-form space-y-6" id="forgot-password-form">
                ...
                <div class="form-group">
                    <input type="email" id="forgot-email" class="form-input" required placeholder=" " />
            ...
            <form class="auth-form space-y-6" id="reset-password-form">
                <div class="text-center">
                    <h1 class="text-2xl font-bold text-white font-['Orbitron']">New Password</h1>
                </div>
                
                <input type="hidden" id="reset-token" value="${resetToken || ""}">
                
                <div class="form-group relative">
                    <input type="password" id="new-password" class="form-input pr-10" required placeholder=" " />
    ...
    setTimeout(() => {
        ...
        const switchAuthView = (viewToShow) => {
            [signinForm, signupForm, otpForm, whatsappUpdateForm, forgotPasswordForm, resetPasswordForm, linkAccountContainer].forEach(form => {
        ...
        if (initialPanel === "reset-password") {
            switchAuthView(resetPasswordForm);
        } else if (initialPanel === "signup") {
            switchAuthView(signupForm);
        } else {
        ...
        if (signinForm) {
            signinForm.addEventListener("submit", async (e) => {
                ...
                const payload = { 
                    email: e.target.elements["signin-username"].value, 
