                                    ...
                                    <div class="space-y-6">
                                        <div class="w-full">
                                            ...
                                            <div class="flex items-center gap-2 mt-2">
                                                <input type="text" readonly value="${plan.v2rayLink}" class="w-full bg-slate-800/50 border border-slate-700 border-radius-50px px-3 py-2 text-sm text-slate-300">
