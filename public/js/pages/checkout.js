...
export function renderCheckoutPage(renderFunc, params) {
                    ...
                    <form id="checkout-form" class="space-y-4">
                        ...
                        <div class="form-group ${isRenewal ? 'pb-2' : ''}">
                            <div class="relative w-full">
                                <input type="text" id="checkout-username" name="username" class="form-input w-full ${!isRenewal ? 'username-input-with-btn' : ''} ${isRenewal ? 'renewal-username-field' : ''}" required placeholder=" " value="${isRenewal ? userToRenew : (isChange ? '' : (userSession.username || ''))}" ${isRenewal ? 'readonly' : ''} autocomplete="off">
    ...
    // --- Username Live Validation Logic (FIXED) ---
    if (!isRenewal) {
    ...
    document.getElementById("checkout-form")?.addEventListener("submit", async (e) => {
        ...
        if (renewUser) {
            ...
            if (!formData.get("username")) formData.append("username", renewUser);
        }
