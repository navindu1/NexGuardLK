...
function renderProfilePage(renderFunc, params) {
  ...
  <label for="plan-selector" class="text-sm font-semibold text-gray-300 flex-shrink-0">Viewing Plan:</label>
  <div class="relative plan-selector-wrapper w-36">
    <select id="plan-selector" class="appearance-none w-full bg-transparent border border-gray-600 rounded-md px-3 py-2 pr-8 text-white"></select>
